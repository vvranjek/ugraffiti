...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        ConnectButtonon = new QPushButton(centralWidget);
        ConnectButtonon->setObjectName(QString::fromUtf8("ConnectButtonon"));
        ConnectButtonon->setGeometry(QRect(10, 10, 89, 25));
        debugEdit = new QTextEdit(centralWidget);
        debugEdit->setObjectName(QString::fromUtf8("debugEdit"));
        debugEdit->setGeometry(QRect(30, 250, 451, 221));
        plainTextEdit = new QPlainTextEdit(centralWidget);
        plainTextEdit->setObjectName(QString::fromUtf8("plainTextEdit"));
        plainTextEdit->setGeometry(QRect(570, 310, 104, 70));
