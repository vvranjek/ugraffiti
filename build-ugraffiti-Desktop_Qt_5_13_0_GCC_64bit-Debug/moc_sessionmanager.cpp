...
QT_MOC_LITERAL(1, 15, 13), // "sessionOpened"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 13), // "sessionClosed"
QT_MOC_LITERAL(4, 44, 12), // "dataReceived"
QT_MOC_LITERAL(5, 57, 4), // "data"
QT_MOC_LITERAL(6, 62, 22), // "fileTransferProgressed"
QT_MOC_LITERAL(7, 85, 7) // "percent"

    },
    "SessionManager\0sessionOpened\0\0"
    "sessionClosed\0dataReceived\0data\0"
    "fileTransferProgressed\0percent"
};
...
void SessionManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sessionClosed(); break;
        case 2: _t->dataReceived((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 3: _t->fileTransferProgressed((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SessionManager::sessionOpened)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SessionManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SessionManager::sessionClosed)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SessionManager::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SessionManager::dataReceived)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SessionManager::fileTransferProgressed)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void SessionManager::sessionOpened()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SessionManager::sessionClosed()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SessionManager::dataReceived(const QByteArray & _t1)
{
...
// SIGNAL 3
void SessionManager::fileTransferProgressed(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
